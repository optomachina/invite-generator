...
- Do not inline motion previews from a static final-state capture. Only include inline animated previews when the evidence spec performs a deliberate interaction or animation sequence and the preview is reviewer-meaningful.
